...
import ru.dinerik.AbstractFactoryDesignPattern.MyAbstractFactory.factory.component.AsianComponentFactory;
import ru.dinerik.AbstractFactoryDesignPattern.MyAbstractFactory.factory.component.BaseComponentFactory;

public class AsianShaurmaFactory implements BaseShaurmaFactory {

    @Override
    public Shaurma createShaurma(ShaurmaType type) {
        Shaurma shaurma;
        BaseComponentFactory componentFactory = new AsianComponentFactory();
