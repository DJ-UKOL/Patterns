...
import ru.dinerik.AbstractFactoryDesignPattern.MyAbstractFactory.factory.shaurma.UzbekShaurmaFactory;

public class UzbekShaurmaFactoryTest {
    @Test
    public void testCreateShaurma() {
        BaseShaurmaFactory shaurmaFactory = new UzbekShaurmaFactory();
